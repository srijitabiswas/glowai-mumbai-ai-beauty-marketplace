        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          ...
          <div className="card-luxury p-8">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="accent-glow-gold w-4 h-4 rounded border-glow-border"
                  />
            ...
            <div className="mt-8 pt-6 border-t border-glow-border text-center">
              <p className="font-inter text-sm text-glow-muted">
                New to GlowAI?{' '}
                <Link to="/register" className="text-glow-gold font-medium hover:underline">Create an account</Link>
              </p>
            </div>
          </div>
        </motion.div>
